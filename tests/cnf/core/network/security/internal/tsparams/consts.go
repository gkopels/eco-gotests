...
const (
	...
	//      table inet custom_table {
	//      }`
	CustomFireWallDelete = `data:;base64,H4sIAAAAAAAC/ypJTMpJVcjMSy1RSC4tLsnPjQeLcKWk5qSWpCrgksYhrlDNVcsFCAAA//9SII3uUwAAAA==`
	...
	// This yaml is created using butane file.  butane mc-update-input-rule8888.bu -o mc-custom-firewall-input-port8888.yaml
	CustomFirewallInputPort8888 = `data:;base64,`
